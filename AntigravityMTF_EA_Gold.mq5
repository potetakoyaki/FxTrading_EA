...
// REVIEW-FIX: Issue 3.2 - Version string updated to v12.3
#property version   "12.30"
#property description "XAUUSD専用 v12.3: 2Dレジーム適応 + セッション×レジーム + 適応出口 + レンジガード + スコアマージン + ATRラチェット"
...
int OnInit()
{
   ...
   // REVIEW-FIX: Issue 3.2 - Version string updated to v12.3
   Print("AntigravityMTF EA [GOLD] v12.3 初期化完了");
