...
input double TP_ATR_Multi      = 2.5;      // TP = M15 ATR x 倍率 (v15.0: 2.5, realistic RR for fixed exit)
input double Trail_ATR_Multi   = 99.0;     // トレーリング = 実質無効 (v14.3: Chandelier単独が最適, PF+0.05)
...
const bool   UseSimpleExitMode = true;     // v15.0: Fixed SL/TP mode (Python-MT5 parity)
