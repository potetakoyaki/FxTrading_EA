//+------------------------------------------------------------------+
//| GoldAlpha_v29.mq5 - Production Release (v28 validated)            |
//| v28 architecture confirmed optimal after exhaustive testing        |
//|                                                                  |
//| Architecture: v12 base + D1 regime + W1 separation +             |
//|   adaptive H4 slope + adaptive SL                                |
//|                                                                  |
//| MT5 Backtest Results (USD $10K, R=0.2%, 2016-2026):              |
//|   PF=2.07, T=671, DD=3.96%, Sharp=1.64                          |
//|   WFA 5/5: 1.18, 1.10, 1.62, 1.53, 2.56                        |
//|   Sensitivity 12/12 PASS (PF range 1.85-2.25 at +/-20%)         |
//|                                                                  |
//| v29 optimization analysis (all degraded WFA):                     |
//|   - Continuation entry: PF=1.81, WFA 3/5 (2016=0.84 FAIL)      |
//|   - Relaxed params (Body=0.28, Zone=0.55): WFA 2/5              |
//|   - Bar 3 check only: PF=1.91, WFA 2016=0.93 FAIL              |
//|   Conclusion: v28 filters are already near-optimal               |
//|                                                                  |
//| Production: R=1.0%, MaxLot=1.00, JPY 300K -> ~7300/day           |
//+------------------------------------------------------------------+
...
void OnTick()
{
   ...
   {double sd=slMult*av;trade.Buy(CalcLot(sd),_Symbol,ask,NormalizeDouble(ask-sd,_Digits),0,"A29 BUY");}
   if(dir==-1&&(CheckSellDip(1,h4e[0],zone)||CheckSellDip(2,h4e[0],zone)))
   {double sd=slMult*av;trade.Sell(CalcLot(sd),_Symbol,bid,NormalizeDouble(bid+sd,_Digits),0,"A29 SELL");}
}
